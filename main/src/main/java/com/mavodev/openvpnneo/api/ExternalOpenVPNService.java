...
public class ExternalOpenVPNService extends Service implements StateListener {
    ...
    private static final String EXTRA_INLINE_PROFILE_ALLOW_VPN_BYPASS = "com.mavodev.openvpnneo.api.ALLOW_VPN_BYPASS";
    ...
    private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
        ...
        private void startProfile(VpnProfile vp)
        {
            ...
            if(vpnPermissionIntent != null || neddPassword != 0){
                ...
                shortVPNIntent.setClass(getBaseContext(), com.mavodev.openvpnneo.LaunchVPN.class);
                shortVPNIntent.putExtra(com.mavodev.openvpnneo.LaunchVPN.EXTRA_KEY, vp.getUUIDString());
                shortVPNIntent.putExtra(com.mavodev.openvpnneo.LaunchVPN.EXTRA_HIDELOG, true);
                shortVPNIntent.putExtra(com.mavodev.openvpnneo.core.OpenVPNService.EXTRA_START_REASON, startReason);
