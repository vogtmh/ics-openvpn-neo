...
import com.mavodev.openvpnneo.api.ExternalCertificateProvider;
...
public class ExtAuthHelper {
    ...
    public static final String ACTION_CERT_CONFIGURATION = "com.mavodev.openvpnneo.api.ExternalCertificateConfiguration";
    public static final String ACTION_CERT_PROVIDER = "com.mavodev.openvpnneo.api.ExternalCertificateProvider";

    public static final String EXTRA_ALIAS = "com.mavodev.openvpnneo.api.KEY_ALIAS";
    public static final String EXTRA_DESCRIPTION = "com.mavodev.openvpnneo.api.KEY_DESCRIPTION";
