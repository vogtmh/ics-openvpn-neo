...
import static com.mavodev.openvpnneo.VpnProfile.EXTRA_PROFILEUUID;
import static com.mavodev.openvpnneo.VpnProfile.EXTRA_PROFILE_VERSION;
import static com.mavodev.openvpnneo.core.ConnectionStatus.LEVEL_CONNECTED;
import static com.mavodev.openvpnneo.core.ConnectionStatus.LEVEL_WAITING_FOR_USER_INPUT;
import static com.mavodev.openvpnneo.core.NetworkSpace.IpAddress;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    public static final String START_SERVICE = "com.mavodev.openvpnneo.START_SERVICE";
    public static final String START_SERVICE_STICKY = "com.mavodev.openvpnneo.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "com.mavodev.openvpnneo.NOTIFICATION_ALWAYS_VISIBLE";

    public static final String EXTRA_DO_NOT_REPLACE_RUNNING_VPN = "com.mavodev.openvpnneo.DO_NOT_REPLACE_RUNNING_VPN";

    public static final String EXTRA_START_REASON = "com.mavodev.openvpnneo.startReason";

    public static final String DISCONNECT_VPN = "com.mavodev.openvpnneo.DISCONNECT_VPN";
    ...
    public static final String EXTRA_CHALLENGE_TXT = "com.mavodev.openvpnneo.core.CR_TEXT_CHALLENGE";
    public static final String EXTRA_CHALLENGE_OPENURL = "com.mavodev.openvpnneo.core.OPENURL_CHALLENGE";
    private static final String PAUSE_VPN = "com.mavodev.openvpnneo.PAUSE_VPN";
    private static final String RESUME_VPN = "com.mavodev.openvpnneo.RESUME_VPN";
    ...
    synchronized void unregisterDeviceStateReceiver(DeviceStateReceiver deviceStateReceiver) {
        if (mDeviceStateReceiver != null)
            try {
                ...
                // java.lang.IllegalArgumentException: Receiver not registered: com.mavodev.openvpnneo.NetworkSateReceiver@41a61a10
                // Ignore for now ...
                iae.printStackTrace();
            }
    }
    ...
    private boolean checkVPNPermission(VpnProfile startprofile) {
        ...
        launchVPNIntent.putExtra(com.mavodev.openvpnneo.LaunchVPN.EXTRA_HIDELOG, true);
    ...
    private OpenVPNManagement instantiateOpenVPN3Core() {
        try {
            Class<?> cl = Class.forName("com.mavodev.openvpnneo.core.OpenVPNThreadv3");
    ...
    private void doSendBroadcast(String state, ConnectionStatus level) {
        ...
        vpnstatus.setAction("com.mavodev.openvpnneo.VPN_STATUS");
