...
import com.mavodev.openvpnneo.api.APIVpnProfile;
import com.mavodev.openvpnneo.api.IOpenVPNStatusCallback; 
...
interface IOpenVPNAPIService {
    ...
    * up to now the only extra that can be put is a boolean "com.mavodev.openvpnneo.api.ALLOW_VPN_BYPASS"
    */
