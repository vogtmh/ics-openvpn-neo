...
jstring Java_com_mavodev_openvpnneo_core_NativeUtils_getOpenVPN2GitVersion(JNIEnv *env, jclass jo)
{

  return (*env)->NewStringUTF(env, OPENVPN2_GIT_REVISION);
}

jstring Java_com_mavodev_openvpnneo_core_NativeUtils_getOpenVPN3GitVersion(JNIEnv *env, jclass jo)
{
