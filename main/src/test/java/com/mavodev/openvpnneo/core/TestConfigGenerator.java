...
import static com.mavodev.openvpnneo.VpnProfile.AUTH_RETRY_NOINTERACT;
import static com.mavodev.openvpnneo.VpnProfile.TYPE_USERPASS;
...
public class TestConfigGenerator {
    ...
    public void testAuthRetryGen() throws PackageManager.NameNotFoundException {
        ...
        when(mc.getPackageName()).thenReturn("com.mavodev.openvpnneo");
        when(mc.getPackageManager()).thenReturn(mpm);
        when(mpm.getPackageInfo(eq("com.mavodev.openvpnneo"),eq(0))).thenReturn(mpi);*/
