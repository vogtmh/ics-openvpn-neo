...
public class SendDumpFragment extends Fragment {
    ...
    public void emailMiniDumps() {
        ...
        uris.add(Uri.parse("content://com.mavodev.openvpnneo.FileProvider/" + ldump.first.getName()));
        uris.add(Uri.parse("content://com.mavodev.openvpnneo.FileProvider/" + ldump.first.getName() + ".log"));
